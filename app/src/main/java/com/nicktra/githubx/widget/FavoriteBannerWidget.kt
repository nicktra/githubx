...
class FavoriteBannerWidget : AppWidgetProvider() {
    companion object {
        ...
        private const val TOAST_ACTION = "com.nicktra.githubx.TOAST_ACTION"
        const val EXTRA_ITEM = "com.nicktra.githubx.EXTRA_ITEM"
        ...
        private fun updateAppWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
            ...
            views.setEmptyView(R.id.stack_view, R.id.widget_empty_view)
